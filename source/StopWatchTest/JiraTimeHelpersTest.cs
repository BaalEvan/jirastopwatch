    ...
    public class JiraTimeHelpersTest
    {
        ...
        */
        ...
        public void JiraRoundUpTo6Or125M_Correct()
        {
            ...
            Assert.That(Round(0, 15, 1), Is.EqualTo(new TimeSpan(0, 15*2, 0)));
            Assert.That(Round(0, 18, 0), Is.EqualTo(new TimeSpan(0, 15*2, 0)));
            Assert.That(Round(0, 18, 1), Is.EqualTo(new TimeSpan(0, 15*2, 0)));
            Assert.That(Round(0, 59, 1), Is.EqualTo(new TimeSpan(1, 0, 0)));
            Assert.That(Round(0, 60, 1), Is.EqualTo(new TimeSpan(1, 15, 0)));
        }
    }
}
